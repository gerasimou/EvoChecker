...
evolve int action_R_Chool [0..4];
evolve int action_R_Fare [0..4];
evolve int action_R_Greta [0..4];
evolve int action_R_Hurratta [0..4];
evolve int action_R_J1 [0..4];
evolve int action_R_J2 [0..4];
evolve int action_R_J3 [0..4];
evolve int action_R_J4 [0..4];
evolve int action_R_Kremshaw [0..4];
evolve int action_R_Moona [0..4];
evolve int action_R_Pretch [0..4];
evolve int action_R_Treebach [0..4];
evolve int action_R_Ulla [0..4];
