...
//Adaptation Step3: Significant decrease in reliability of services op1S1 (op1S1Fail=0.11) & op1S3 (op1S3Fail=0.07) & op1S4 (op1S4Fail=0.02)
...
const double op1S3Fail=0.07; //failure probability of service 3 op1
const double op1S4Fail=0.02; //failure probability of service 4 op1
