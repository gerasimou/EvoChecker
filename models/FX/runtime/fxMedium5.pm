...
//Adaptation Step5: Significant decrease in reliability of services op2S1 (op2S1Fail=0.53) & op2S2 (op2S2Fail=0.53) & op2S4 (op2S4Fail=0.038)
dtmc
...
const double op2S1Fail=0.053; //failure probability of service 1 op2
const double op2S2Fail=0.055; //failure probability of service 2 op2
const double op2S3Fail=0.006; //failure probability of service 3 op2
const double op2S4Fail=0.038; //failure probability of service 4 op1
