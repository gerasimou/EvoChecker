...
//Adaptation Step7: Small change in reliability of services op1S1 (op1S1Fail=0.0108) & op1S3 (op1S3Fail=0.0065) & op1S4 (op1S4Fail=0.003)
dtmc
...
const double op1S1Fail=0.0108; //failure probability of service 1 op1
const double op1S2Fail=0.004; //failure probability of service 2 op1
const double op1S3Fail=0.0065; //failure probability of service 3 op1
const double op1S4Fail=0.003; //failure probability of service 4 op1
