...
//Adaptation Step11: Small change in response time of services op5S1 (op5S1Time=4.15) & op5S2 (op5S2Time=3.65) & op5S3 (op5S3Time=3.7)
dtmc
...
const double op5S1Time=4.15; //response time of service 1 op4
const double op5S2Time=3.65; //response time of service 2 op4
const double op5S3Time=3.7; //response time of service 3 op4
