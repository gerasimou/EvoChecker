 ...
 */
public class RandomSearchSingle_Settings extends Settings{
	 ...
	 */
	public RandomSearchSingle_Settings(String problemName, Problem problem){
		super(problemName);
		problem_ 			= problem;
	...
	public Algorithm configure() throws JMException {
		...
		MultiProcessPrismEvaluator mpPrismEvaluator = new MultiProcessPrismEvaluator(0);
		
		//create a new algorithm object
		Algorithm algorithm = new pRandomSearchSingle(problem_, mpPrismEvaluator);
