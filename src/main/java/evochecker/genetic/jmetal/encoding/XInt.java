...
public class XInt {
  ...
  private XInt() {
	...
	public int getValue(int index) throws JMException {
		...
		else if (type_.getClass() == ArrayRealIntSolutionType.class) {
			return ((ArrayInt)(solution_.getDecisionVariables()[1])).array_[index];
		}
		else {
	...
	public void setValue(int index, int value) throws JMException {
		if (type_.getClass() == IntSolutionType.class)
			...
			((ArrayInt)(solution_.getDecisionVariables()[1])).array_[index]=value ;
		else
	...
	public int getLowerBound(int index) throws JMException {
		if (type_.getClass() == IntSolutionType.class)
			...
			return (int)((ArrayInt)(solution_.getDecisionVariables()[1])).getLowerBound(index) ;
		else {
	...
	public int getUpperBound(int index) throws JMException {
		if (type_.getClass() == IntSolutionType.class)		
			...
			return (int)((ArrayInt)(solution_.getDecisionVariables()[1])).getUpperBound(index) ;
		else
	...
	public int getNumberOfDecisionVariables() {
		if (type_.getClass() == IntSolutionType.class)		
			...
			return ((ArrayInt)(solution_.getDecisionVariables()[1])).getLength() ;
		else
