...
package evochecker.genetic.jmetal.experiments;
...
public abstract class Experiment {
  ...
  public Experiment() {
    ...
    indicatorMinimize_.put("GENSPREAD", true);
        ...
        for (int problemIndex = 0; problemIndex < problemList_.length; problemIndex++) {
          ...
          for (String anIndicatorList_ : indicatorList_) {
            ...
            for (int numRun = 0; numRun < independentRuns_; numRun++) {
              ...
              //GeneralisedSpread
              if (anIndicatorList_.equals("GENSPREAD")){
            	  ...
            	  qualityIndicatorFile = qualityIndicatorFile + "/GENSPREAD";
              }
