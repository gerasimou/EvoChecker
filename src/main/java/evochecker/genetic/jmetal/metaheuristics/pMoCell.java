	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		...
		while (evaluations < maxEvaluations) {
			...
			for (int index = 0; index < population.size(); index++) {
				...
				// TODO: Fix the exception from .getEightNeighbors
				// This is probably related to the population being under-sized
				// compared to what is expected, likely because zealous constraints are
				// 'killing' individuals which would otherwise populate it.
