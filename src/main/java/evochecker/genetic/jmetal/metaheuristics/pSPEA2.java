...
public class pSPEA2 extends Algorithm {
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		...
		/*
		 * TODO: investigate if SPEA2 is implemented correctly.
		 * It seems that the archive can be empty, which should not really be the case.
		 * If over-bearing constraints are really stopping any individuals from
		 * existing, perhaps an edge-case needs to be implemented if the archive is
		 * accessed whilst it is empty (or of unsufficient dimension).
		 */
		// Generations
