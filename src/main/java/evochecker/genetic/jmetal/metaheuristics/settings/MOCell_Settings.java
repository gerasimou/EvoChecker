...
public class MOCell_Settings extends Settings {
  ...
  public MOCell_Settings(String problemName, Problem problem) {
    ...
    // realMutationProbability_ = 1.0 /
    // ((GeneticProblem)problem_).getNumOfRealVariables();// 0.4;
    // intMutationProbability_ = 1.0 /
    // ((GeneticProblem)problem_).getNumOfIntVariables();//0.4;
